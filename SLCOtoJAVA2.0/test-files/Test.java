  ...
  public volatile int y;
	...
	class java_SM1Thread extends Thread {
        ...
        boolean execute_SMC0_0() {
          ...
          if (!(!(x[i]))) { java_kp.unlock(java_lockIDs, 3); java_transcounter++; return false; }
          i = i + 1;
          x[i] = i == 2;
          i = 3;
          x[0] = false;
          ...
          if (!(x[i])) { java_kp.unlock(java_lockIDs, 1); java_transcounter++; return false; }
          //System.out.println("SM1_SMC0__unlock");
		...
		public void exec() {
			...
			while(java_transcounter < java_COUNTER_BOUND) {
				...
				switch(java_currentState) {
					case SMC0:
						//System.out.println("SM1_SMC0 " + java_transcounter);
						...
						switch(java_choice) {
							case 0:
								...
								if (execute_SMC0_0()) {
								  ...
								  // Increment counter
								  //System.out.println("SM1_SMC0_0_increment");
								  java_transcounter++;
								}
								break;
							case 1:
								...
								if (execute_SMC0_1()) {
								  ...
								  java_currentState = Test.java_State.SMC0;
								  // Increment counter
								  //System.out.println("SM1_SMC0_1_increment");
								  java_transcounter++;
								}
								break;
						}
	...
	class java_ComThread extends Thread {
        ...
        boolean execute_Com0_0() {
          // lx = 0
          if (!(lx == 0)) { java_transcounter++; return false; }
          return true;
        }
		...
		public void exec() {
			...
			while(java_transcounter < java_COUNTER_BOUND) {
				...
				switch(java_currentState) {
					case Com0:
						//System.out.println("Com_Com0 " + java_transcounter);
                        if (execute_Com0_0()) {
						  // Change state
